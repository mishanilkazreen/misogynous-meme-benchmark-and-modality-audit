...
uv run python scripts/benchmark_visualbert.py --split test --device cuda --use-ocr --ocr-engine paddleocr
uv run python scripts/benchmark_visualbert.py --split test --device cuda --use-ocr --ocr-engine paddleocr --task multiclass
