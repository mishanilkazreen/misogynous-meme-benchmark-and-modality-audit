...
class VLMCollate:
    ...
    def __init__(self, processor: Any, model_type: str, task: str, ocr_map: dict[str, str] | None = None) -> None:
...
def main() -> None:
    ...
    parser.add_argument("--model-id", default="Qwen/Qwen2-VL-2B-Instruct", help="HuggingFace model ID")
    ...
    parser.add_argument("--limit", type=int, default=None, help="Limit sample count for smoke testing")
    parser.add_argument(
        "--use-ocr",
        action="store_true",
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        for batch_idx, batch in enumerate(train_loader):
            ...
            model_inputs = {k: v.to(args.device) if isinstance(v, torch.Tensor) else v for k, v in batch.items()}
