...
| :---: | :--- | :---: | :--- | :--- |
| 1-3 | Fix trad ML pipeline (ViT-L-14 + PaddleOCR), add multiclass, rerun | [#84](https://github.com/mishanilkazreen/misogynous-meme-benchmark-and-modality-audit/issues/84) | Mani | Submitted to SCIAMA |
| 4 | Qwen2-VL-2B zero-shot Task B | [#93](https://github.com/mishanilkazreen/misogynous-meme-benchmark-and-modality-audit/issues/93) | Mani | Submitted to SCIAMA |
| 5 | CLIP ViT-B-32 fine-tuned Task B | [#94](https://github.com/mishanilkazreen/misogynous-meme-benchmark-and-modality-audit/issues/94) | Mani | Submitted to SCIAMA |
| 6-8 | Advanced metrics + consolidated table | [#65](https://github.com/mishanilkazreen/misogynous-meme-benchmark-and-modality-audit/issues/65) | Mani | Blocked on 1-5 |
| 9 | CLIP ViT-B-32 zero-shot baselines | [#95](https://github.com/mishanilkazreen/misogynous-meme-benchmark-and-modality-audit/issues/95) | Mani | Submitted to SCIAMA |
| 10 | SOTA literature table with timings | [#88](https://github.com/mishanilkazreen/misogynous-meme-benchmark-and-modality-audit/issues/88) + [#68](https://github.com/mishanilkazreen/misogynous-meme-benchmark-and-modality-audit/issues/68) | Mishanil + Louis | In progress |
| 11 | SOTA explainability survey | [#88](https://github.com/mishanilkazreen/misogynous-meme-benchmark-and-modality-audit/issues/88) | Mishanil + Louis | Done |
| 12 | Modality-Level SHAP Attribution | [#89](https://github.com/mishanilkazreen/misogynous-meme-benchmark-and-modality-audit/issues/89) | Mani | Blocked on #84 |
| 13 | CLIP Concept Activation Vectors | [#89](https://github.com/mishanilkazreen/misogynous-meme-benchmark-and-modality-audit/issues/89) | Mani | Blocked on #84 |
