...
class TestVLMBench(unittest.TestCase):
    ...
    def test_run_vlm_inference_florence(self, mock_cuda):
        ...
        mock_processor.return_value = {"input_ids": torch.tensor([[1, 2]]), "pixel_values": torch.tensor([[[[1.0]]]])}
        ...
        mock_processor.assert_called_once_with(text="Classify this image", images=image, return_tensors="pt")
    ...
    def test_run_vlm_inference_qwen2_vl(self, mock_cuda):
        ...
        mock_processor.assert_called_once_with(text=["templated prompt"], images=[image], padding=True, return_tensors="pt")
        mock_model.generate.assert_called_once()
