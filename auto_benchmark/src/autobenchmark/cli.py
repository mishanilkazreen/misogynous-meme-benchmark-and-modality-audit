...
def run_detect(args):
    ...
    import yaml
    from pathlib import Path
    from autobenchmark.yolo_models import train_yolo_benchmark, resolve_data_yaml
...
def run_classify(args):
    ...
    if data_type != 'image_classification':
        print(f"Error: data_type must be 'image_classification' for the classify command, got '{data_type}'.")
        return
...
def main():
    ...
    parser_profile.add_argument('--init', type=str, default='config/init_config.yaml',
                                 help='Path to system initialization YAML configuration')
    parser_profile.add_argument('--data', type=str, required=True,
                                 help='Path to data configuration (e.g. config/data/data1.yaml)')
    
    # 2. Train command
    parser_train = subparsers.add_parser("train", help="Train and benchmark ML models on tabular/text data")
    parser_train.add_argument('--init', type=str, default='config/init_config.yaml',
                                help='Path to system initialization YAML configuration')
    ...
    # 3. Explain command
    parser_explain = subparsers.add_parser("explain", help="Generate explanations for a trained model")
    parser_explain.add_argument('--init', type=str, default='config/init_config.yaml',
                                 help='Path to system initialization YAML configuration')
    parser_explain.add_argument('--explainer', type=str, required=True,
    ...
    parser_detect = subparsers.add_parser("detect", help="Benchmark YOLO object detection models on an image dataset")
    parser_detect.add_argument('--init', type=str, default='config/init_config.yaml',
                                help='Path to system initialization YAML configuration')
    ...
    parser_classify = subparsers.add_parser("classify", help="Benchmark Image Classification models on a directory of images")
    parser_classify.add_argument('--init', type=str, default='config/init_config.yaml',
                                 help='Path to system initialization YAML configuration')
    parser_classify.add_argument('--model', type=str, required=True,
                                 help='Path to image classification model config (e.g. config/model/image_class_model1.yaml)')
    
    # 6. VLM benchmarking command
    parser_vlmbench = subparsers.add_parser("vlmbench", help="Benchmark Vision-Language Models (VLMs) on an image dataset")
    parser_vlmbench.add_argument('--init', type=str, default='config/init_config.yaml',
                                 help='Path to system initialization YAML configuration')
    parser_vlmbench.add_argument('--model', type=str, required=True,
